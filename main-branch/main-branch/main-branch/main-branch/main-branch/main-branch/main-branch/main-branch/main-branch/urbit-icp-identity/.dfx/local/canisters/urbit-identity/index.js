...
import { idlFactory } from './urbit-identity.did.js';
export { idlFactory } from './urbit-identity.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_URBIT_IDENTITY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./urbit-identity.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the urbit-identity canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./urbit-identity.did.js")._SERVICE>}
 */
export const urbit_identity = createActor(canisterId);
