...
**Option B**: `grainstore/grain6pbc/teamillumine13/graintime/`
...
**Original Location**: `grainstore/grain6pbc/teamrebel10/graintime/`  
**Author**: kae3g  
...
```bash
cd grainstore/grain6pbc/teamrebel10/graintime
bb now teamabsorb14
```
