...
**Extends**: `grain6pbc/teamrebel10/grainpersona/` (template)  
...
**Template Side** (`grainstore/grain6pbc/teamrebel10/`):
...
```
Template (grain6pbc)          Personal (teamrebel10)
     │                                 │
...
**Location**: `writings/roadmap.md` (mirrors `grain6pbc/teamrebel10/ROADMAP-TEAM10-12025-10-24.md`)
