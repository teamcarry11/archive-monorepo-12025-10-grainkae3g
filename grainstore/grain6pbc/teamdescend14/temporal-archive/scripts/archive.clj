...
(def session-files
  ...
  [;; Personal notes
   ...
   ;; Architecture
   "grainstore/grain6pbc/teamnurture04/GRAINBARREL-KETOS-ARCHITECTURE.md"
   "grainstore/grain6pbc/teamnurture04/UNIVERSAL-PACKAGE-ABSTRACTION.md"
   "grainstore/grain6pbc/teamascend13/GRAINORDER-SPEC.md"
   "grainstore/grain6pbc/teamascend13/CHARTCOURSE-RANGE-CALCULATION.md"
   "grainstore/grain6pbc/teamdescend14/GRAINTIME-ASCENDANT-DEBUG.md"
   
   ;; Session docs
   "grainstore/grain6pbc/teamdescend14/gkh-chartcourse-ketos-vision-session.md"
   "grainstore/grain6pbc/teamdescend14/gkh-ARE-WE-ON-TRACK.md"
   "grainstore/grain6pbc/teamdescend14/GRAIN-NETWORK-DIRECTORY.md"
   
   ;; Ketos Synthesis
   "grainstore/grain6pbc/teamdescend14/KETOS-VISION-SYNTHESIS/INDEX.md"
   "grainstore/grain6pbc/teamdescend14/KETOS-VISION-SYNTHESIS/xbd-team14-ketos-descent-philosophy.md"
   
   ;; Personas
   "grainstore/grain6pbc/teamstructure10/grainpersona/GLOW-PERSONA-V2.md"
   
   ;; Friends
   "grainstore/grain6pbc/teamnurture04/grainfriends/README.md"])

(defn archive-session!
  "Archive all files from current session (gkh)."
  []
  (let [archive-base "grainstore/grain6pbc/teamdescend14/temporal-archive"]
