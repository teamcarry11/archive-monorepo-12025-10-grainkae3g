...
grain6pbc/babashka, grain6pbc/clojure, grain6pbc/* = OURS
...
## The Six in grain6pbc

**grain6pbc** = Grain + 6 Principles + Public Benefit Corporation
...
New: grain://teamflow12/grainflow
...
**Alternative**: If you want to emphasize "zero-six" for some reason, grain06pbc works too

**My feeling**: grain6pbc is perfect. Don't change it. 💕
