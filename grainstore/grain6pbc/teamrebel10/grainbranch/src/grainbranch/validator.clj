...
(defn parse-grainbranch
  "Parse grainbranch name into components for validation.
   ...
   Example:
   'gkh-chartcourse------12025-10-26--1048-PST--moon-mula----------asc-erro00-sun-03h--teamabsorb14'
...
(defn format-grainbranch
  "Format grainbranch name with proper padding and validation.
   ...
   - team: Team name (e.g., 'teamabsorb14')
...
(comment
  ...
  (validate-grainbranch
    "gkh-chartcourse-ketos-vision--2025-10-26--1044--PST--moon-mula--asc-erro00--sun-03h--teamabsorb14")
