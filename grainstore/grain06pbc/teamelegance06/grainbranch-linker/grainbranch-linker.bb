...
(defn generate-grainbranch-structure
  ...
  TEMPLATE SIDE (grain06pbc/teamNAME##/MODULE/):
  ...
  (let [team-info (get teams team-key)
        ...
        template-path (str "grainstore/grain06pbc/team" team-num "/" module-name "/")
...
(defn generate-grainbranch-section
  ...
  (str "## 🌾 Grainbranch: " grainbranch-name "\n"
       ...
       "\n"
       "**Template ↔ Personal:**\n"
       "- **Template (specs):** `grain06pbc/team*/MODULE/` - shared, reusable foundation\n"
