...
```
grain06pbc/grainmock/              ← Template (gitignored personal/)
├── src/grainmock/
│   ├── core.clj                 ← Main API
...
### **grain06pbc/grainmock (Template)**

```
grain06pbc/grainmock/
├── src/grainmock/
...
```bash
cd /home/xy/kae3g/grainkae3g/grainstore/grain06pbc/grainmock
bb install
```
