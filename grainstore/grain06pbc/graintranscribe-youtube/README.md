...
A grain06pbc template module for transcribing YouTube videos using Google's Gemini 2.5 Pro AI, part of Google AI Premium ($20/month) or Google One AI Premium ($19.99/month with 2TB storage).
...
```bash
cd grainstore/grain06pbc/graintranscribe-youtube
bb config:setup
```
...
cd grainstore/
git clone https://github.com/grain06pbc/graintranscribe-youtube
```

Or as a submodule:

```bash
git submodule add https://github.com/grain06pbc/graintranscribe-youtube \
  grainstore/grain06pbc/graintranscribe-youtube
```
...
This is a grain06pbc template module. Contributions should maintain template/personal separation.
...
- **Grainpbc**: https://github.com/grain06pbc
