...
#### **grainenvvars**
```bash
cd grainstore/grain06pbc/teamelegance06/grainenvvars
git init
...
#### **grainzsh**
```bash
cd grainstore/grain06pbc/teamelegance06/grainzsh
git init
...
#### **grainchart**
```bash
cd grainstore/grain06pbc/teamelegance06/grainchart
git init
...
#### **graindrive**
```bash
cd grainstore/grain06pbc/teamtreasure02/graindrive
git init
