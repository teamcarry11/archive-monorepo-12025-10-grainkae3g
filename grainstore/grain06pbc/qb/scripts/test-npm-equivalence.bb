...
;; the exact same functionality as grain06pbc/qb module

(require '[babashka.process :refer [shell]]
         '[clojure.string :as str])

(defn test-npm-equivalence
  "Test that NPM quarterback package provides same functionality as grain06pbc/qb"
  []
  ...
  (println "as the grain06pbc/qb module, making it installable via:")
