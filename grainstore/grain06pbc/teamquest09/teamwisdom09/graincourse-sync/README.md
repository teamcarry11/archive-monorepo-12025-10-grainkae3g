...
- `grain06pbc/graincourse` - Course content management
- `grain06pbc/grainpages` - Static site generation
- `grain06pbc/grainsource-separation` - Configuration pattern
