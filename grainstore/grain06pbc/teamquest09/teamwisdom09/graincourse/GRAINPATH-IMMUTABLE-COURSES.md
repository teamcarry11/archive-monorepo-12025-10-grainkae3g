...
**GitHub**: `https://github.com/grain06pbc/course-{author}-{course-name}-{version}`
**Codeberg**: `https://codeberg.org/grain06pbc/course-{author}-{course-name}-{version}`

**Examples:**
- `grain06pbc/course-kae3g-grain-network-course-v1.0.0`
- `grain06pbc/course-student-algebra-basics-v2.1.0`
- `grain06pbc/course-teacher-advanced-calculus-v1.5.0`
...
# - GitHub repo: grain06pbc/course-kae3g-grain-network-course-1.0.0
# - Codeberg repo: grain06pbc/course-kae3g-grain-network-course-1.0.0
```
...
{:course
 {:grainpath "/course/kae3g/grain-network-course/v1.0.0/"
  ...
  :repositories
  {:github "https://github.com/grain06pbc/course-kae3g-grain-network-course-1.0.0"
   :codeberg "https://codeberg.org/grain06pbc/course-kae3g-grain-network-course-1.0.0"}
  
  :pages
  {:github "https://grain06pbc.github.io/course-kae3g-grain-network-course-1.0.0"
   :codeberg "https://grain06pbc.codeberg.page/course-kae3g-grain-network-course-1.0.0"}
...
{:grainpath
 {:path "/course/kae3g/grain-network-course/v1.0.0/"
  ...
  :repositories
  {:github "grain06pbc/course-kae3g-grain-network-course-1.0.0"
   :codeberg "grain06pbc/course-kae3g-grain-network-course-1.0.0"}
...
1. **GitHub Pages**: `https://grain06pbc.github.io/course-{author}-{name}-{version}/`
2. **Codeberg Pages**: `https://grain06pbc.codeberg.page/course-{author}-{name}-{version}/`
