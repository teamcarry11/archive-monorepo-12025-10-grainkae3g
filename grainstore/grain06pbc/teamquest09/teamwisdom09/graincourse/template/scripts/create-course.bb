...
(defn create-course-edn [author course-name course-dir]
 ...
 {:grainpath \"" grainpath "\"
  ...
  :repositories
  {:github \"https://github.com/grain06pbc/" repo-name "\"
   :codeberg \"https://codeberg.org/grain06pbc/" repo-name "\"}
  
  :pages
  {:github \"https://grain06pbc.github.io/" repo-name "\"
   :codeberg \"https://grain06pbc.codeberg.page/" repo-name "\"}
  ...
  {:home-text \"🏠 Course Home\"
   :github-url \"https://github.com/grain06pbc/" repo-name "\"
   :codeberg-url \"https://codeberg.org/grain06pbc/" repo-name "\"
   :github-pages \"https://grain06pbc.github.io/" repo-name "/\"
   :codeberg-pages \"https://grain06pbc.codeberg.page/" repo-name "/\"}
  ...
  :deployment
  {:github {:org \"grain06pbc\" :repo \"" repo-name "\" :branch \"gh-pages\"}
   :codeberg {:org \"grain06pbc\" :repo \"" repo-name "\" :branch \"pages\"}}}}")]
...
(defn create-grainpath-edn [author course-name course-dir]
 ...
 {:path \"" grainpath "\"
  ...
  :repositories
  {:github \"grain06pbc/" repo-name "\"
   :codeberg \"grain06pbc/" repo-name "\"}
...
(defn create-github-repo [repo-name]
  ...
  (try
    (shell (str "gh repo create grain06pbc/" repo-name " --public --description \"Immutable course: " repo-name "\""))
...
(defn create-codeberg-repo [repo-name]
  ...
  (try
    (shell (str "gh repo create codeberg.org/grain06pbc/" repo-name " --public --description \"Immutable course: " repo-name "\""))
