...
```
┌──────────────────────────────────────────────────────────────────────────────┐
│ GRAINCARD xbdghn                              grain    of 1,235,520 │
│ Topic: Grainorder - Universal Ordering System                                │
│ Team: 13 (teamillumine13 - The Hanged Man ♆)                                   │
...
│                                                                              │
│ THE IMPLEMENTATION:                                                          │
│ Location: grainstore/grain06pbc/teamillumine13/grainorder/                      │
│ Language: Clojure                                                            │
...
│                                                                              │
│ Next: [xbdghs](xbdghs-graintime-temporal-calculation.md) →                   │
│ now == next + 1 🌾                                                           │
└──────────────────────────────────────────────────────────────────────────────┘
```
