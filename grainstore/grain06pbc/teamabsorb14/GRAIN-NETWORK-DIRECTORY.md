...
### **grain06pbc** (Template/Spec Organization)
- **URL**: https://github.com/grain06pbc
- **Purpose**: Public templates, specifications, base definitions
- **Type**: Public, shared, reusable
- **Location**: `grainstore/grain06pbc/` (local mirror)
...
### **Team01 - teambright01** (Aries ♈ / I. The Magician)
**Location**: `grainstore/grain06pbc/teambright01/`

#### **grain6**
- **Path**: `teambright01/grain6/`
- **Purpose**: Core Grain OS specification
- **Status**: Specification phase

#### **grainbarrel** (Original)
- **Path**: `teambright01/grainbarrel/`
...
#### **grainconfig**
- **Path**: `teambright01/grainconfig/`
- **Purpose**: Configuration management
- **Status**: Active

---

### **Team02 - teamtreasure02** (Taurus ♉ / II. The High Priestess)
**Location**: `grainstore/grain06pbc/teamtreasure02/`

#### **grainclay**
- **Path**: `teamtreasure02/grainclay/`
...
**Location**: `grainstore/grain06pbc/teamdance03/`
...
### **Team04 - teamplay04** (Cancer ♋ / IV. The Emperor)
**Location**: `grainstore/grain06pbc/teamplay04/`

#### **grainbarrel** (New Home)
- **Path**: `teamplay04/grainbarrel/`
...
**Location**: `grainstore/grain06pbc/teamshine05/`
...
### **Team06 - teamelegance06** (Virgo ♍ / VI. The Lovers)
**Location**: `grainstore/grain06pbc/teamelegance06/`

#### **grainenvvars**
- **Path**: `teamelegance06/grainenvvars/`
- **Purpose**: Environment variable management
- **Created**: 2025-10-25
- **Key File**: `README.md` (Chanel Spring/Summer metaphors, security)

#### **grainzsh**
- **Path**: `teamelegance06/grainzsh/`
- **Purpose**: Zsh configuration, shell precision
- **Created**: 2025-10-25
- **Key File**: `README.md` (λ prompt specs, Fall/Winter aesthetic)

#### **grainchart**
- **Path**: `teamelegance06/grainchart/`
...
#### **graindualwifi** ⭐ NEW!
- **Path**: `teamelegance06/graindualwifi/`
...
#### **chartcourse**
- **Path**: `teamelegance06/chartcourse/`
...
**Location**: `grainstore/grain06pbc/teaminspire07/`
...
**Location**: `grainstore/grain06pbc/teamtransform08/`

**Status**: Directory exists, modules pending

---

### **Team09 - teamquest09** (Sagittarius ♐ / IX. The Hermit)
**Location**: `grainstore/grain06pbc/teamquest09/`

**Status**: Directory exists, modules pending

---

### **Team10 - teamrebel10** (Capricorn ♑ / X. Wheel of Fortune)
**Location**: `grainstore/grain06pbc/teamrebel10/`

#### **graintime** ⭐ MAJOR UPDATE (2025-10-26)
- **GitHub**: https://github.com/grain06pbc/teamshine05/graintime
- **Path**: `teamshine05/graintime/`
...
- **Usage**: `bb format-quick gkh chartcourse 12025-10-26 1048 PST mula erro 00 03 teamabsorb14`

#### **grainpersona** ✨ NEW (2025-10-26)
- **Path**: `teamrebel10/grainpersona/`
...
#### **grainsource-vegan**
- **Path**: `teamrebel10/grainsource-vegan/`
...
**Location**: `grainstore/grain06pbc/teamhelp11/`

**Status**: Directory exists, modules pending

---

### **Team12 - teamtravel12** (Pisces ♓ / XII. The Hanged Man)
**Location**: `grainstore/grain06pbc/teamtravel12/`

#### **grainflow**
- **Path**: `teamtravel12/grainflow/`
- **Purpose**: Flow state management, build pipelines
- **Status**: Specification phase

#### **grain-metatypes**
- **Path**: `teamtravel12/grain-metatypes/`
- **Purpose**: Type systems, meta-level abstractions
- **Status**: Documentation

#### **grainneovedic**
- **Path**: `teamtravel12/grainneovedic/`
- **Purpose**: Vedic astrology integration
- **Status**: Documentation

#### **grainsource-separation**
- **Path**: `teamtravel12/grainsource-separation/`
- **Purpose**: Template/personal separation patterns
- **Status**: Documentation

---

### **Team13 - teamillumine13** (Aries ♈ / XIII. Death)
**Location**: `grainstore/grain06pbc/teamillumine13/`

#### **grainorder** ✨ NEW (2025-10-26)
- **Path**: `teamillumine13/grainorder/`
...
### **Team14 - teamabsorb14** (Pisces ♓ / XIV. Temperance)
**Location**: `grainstore/grain06pbc/teamabsorb14/`
...
- **Path**: `teamabsorb14/KETOS-VISION-SYNTHESIS/`
...
### **grainstore/teamrebel10/**
**Location**: `grainstore/teamrebel10/`

#### **grainteamrebel10mode**
- **Path**: `teamrebel10/grainteamrebel10mode/`
- **Purpose**: Team10-specific modes and configurations
- **Status**: Active

---

### **grainstore/teamelegance06/**
**Location**: `grainstore/teamelegance06/`

#### **grainteamelegance06mode**
- **Path**: `teamelegance06/grainteamelegance06mode/`
...
### **Build Tools**
- **Babashka**: `bb` command (delegated to `grainstore/grain06pbc/teamplay04/grainbarrel/`)
...
**Template Side** (grain06pbc org):
- Location: `grainstore/grain06pbc/team[NAME]##/grain[concept]/`
- Contains: Specs, base definitions, schema, template docs
- Purpose: Shared, reusable, general-purpose
- Example: `grain06pbc/teamshine05/graintime/` (graintime specs)

**Personal Side** (teamrebel10 org):
- Location: `grainstore/teamrebel10/grainteam[NAME]##[concept]/`
- Contains: Implementation, personal configs, extended functionality
- Purpose: Customized, specific, personalized
- Example: `teamrebel10/grainteamrebel10mode/` (personal mode configs)

**Flow**:
1. Create template in grain06pbc (specs + base)
...
**Organizations**:
- Templates: https://github.com/grain06pbc
