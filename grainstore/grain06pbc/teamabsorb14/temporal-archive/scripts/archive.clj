...
(def session-files
  ...
  [;; Personal notes
   ...
   ;; Architecture
   "grainstore/grain06pbc/teamplay04/GRAINBARREL-KETOS-ARCHITECTURE.md"
   "grainstore/grain06pbc/teamplay04/UNIVERSAL-PACKAGE-ABSTRACTION.md"
   "grainstore/grain06pbc/teamillumine13/GRAINORDER-SPEC.md"
   "grainstore/grain06pbc/teamillumine13/CHARTCOURSE-RANGE-CALCULATION.md"
   "grainstore/grain06pbc/teamabsorb14/GRAINTIME-ASCENDANT-DEBUG.md"
   
   ;; Session docs
   "grainstore/grain06pbc/teamabsorb14/gkh-chartcourse-ketos-vision-session.md"
   "grainstore/grain06pbc/teamabsorb14/gkh-ARE-WE-ON-TRACK.md"
   "grainstore/grain06pbc/teamabsorb14/GRAIN-NETWORK-DIRECTORY.md"
   
   ;; Ketos Synthesis
   "grainstore/grain06pbc/teamabsorb14/KETOS-VISION-SYNTHESIS/INDEX.md"
   "grainstore/grain06pbc/teamabsorb14/KETOS-VISION-SYNTHESIS/xbd-team14-ketos-descent-philosophy.md"
   
   ;; Personas
   "grainstore/grain06pbc/teamrebel10/grainpersona/GLOW-PERSONA-V2.md"
   
   ;; Friends
   "grainstore/grain06pbc/teamplay04/grainfriends/README.md"])

(defn archive-session!
  "Archive all files from current session (gkh)."
  []
  (let [archive-base "grainstore/grain06pbc/teamabsorb14/temporal-archive"]
