...
**Core Template** (`grain06pbc/grain6`):
...
- `grain06pbc/grain6-education`: Educational institutions
- `grain06pbc/grain6-enterprise`: Corporate environments
- `grain06pbc/grain6-research`: Academic research
- `grain06pbc/grain6-community`: Community organizations

**Personal Templates**:
- `grain06pbc/grain6-personal`: Individual developers
- `grain06pbc/grain6-student`: Students and learners
- `grain06pbc/grain6-contributor`: Open source contributors
- `grain06pbc/grain6-maintainer`: Project maintainers
