...
The grain06pbc template system now supports script-based configuration updates, allowing personal customization while maintaining template consistency.
...
- **Module-Specific Configs**: Individual configuration for each grain06pbc module
...
Stored in `grain06pbc/grainconfig/config.edn`:
...
```bash
# Create: grain06pbc/grainconfig/scripts/grainconfig-{module}.bb
```
...
- GitHub Issues: [grain06pbc/grainconfig/issues](https://github.com/grain06pbc/grainconfig/issues)
- Codeberg Issues: [grain06pbc/grainconfig/issues](https://codeberg.org/grain06pbc/grainconfig/issues)
