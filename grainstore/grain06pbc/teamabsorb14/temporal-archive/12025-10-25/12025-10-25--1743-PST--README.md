...
λ cd grainstore/grain06pbc/teamelegance06
λ
```
...
```bash
# Clone template repo
git clone https://github.com/grain06pbc/grainzsh.git ~/.grainzsh
...
alias g6='cd ~/kae3g/grainkae3g/grainstore/grain06pbc'
alias g10='cd ~/kae3g/grainkae3g/grainstore/grain06pbc/teamrebel10'
alias g06='cd ~/kae3g/grainkae3g/grainstore/grain06pbc/teamelegance06'
alias g14='cd ~/kae3g/grainkae3g/grainstore/grain06pbc/teamabsorb14'
...
```bash
# Fork to grain06pbc
git clone https://github.com/grain06pbc/grainzsh.git
...
- **grainSOURCE**: https://github.com/grain06pbc/grainzsh
- **grainSITE**: https://grain06pbc.github.io/grainzsh/
