...
### Foundation Layer (Template - grain06pbc org)
...
### Ethics Layer (Template - grain06pbc org)
- `grainsource-vegan` - Ethical validation specs (Ketu foundation)

### AI Layer (Template - grain06pbc org)
- `grainai-voice` - Voice personality structure specs

### Systems Layer (Template - grain06pbc org)
...
**Templates (grain06pbc/teamrebel10/*):**
- Public, shared specs
- Base definitions
- Reusable patterns
- Deployed to grain06pbc org
