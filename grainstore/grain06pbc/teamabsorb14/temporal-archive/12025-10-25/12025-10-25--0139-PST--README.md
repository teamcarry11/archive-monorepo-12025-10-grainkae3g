...
**Extends**: `grain06pbc/teamrebel10/grainpersona/` (template)  
...
**Template Side** (`grainstore/grain06pbc/teamrebel10/`):

Located in the public `grain06pbc` organization, these are SHARED SPECS and BASE DEFINITIONS that any team can use:
...
```
Template (grain06pbc)          Personal (teamrebel10)
     │                                 │
...
**Location**: `writings/roadmap.md` (mirrors `grain06pbc/teamrebel10/ROADMAP-TEAM10-12025-10-24.md`)
...
**Template Repos** (grain06pbc org):
- github.com/grain06pbc/grainpersona
- github.com/grain06pbc/grainsource-vegan
- github.com/grain06pbc/grain-musl
