...
(defn create-grainbranch
  "Create immutable grainbranch with graintime stamp
   ...
   ;;     :url \"https://github.com/grain06pbc/graintime/tree/grainbranch-2025-10-24--1542--PDT--moon-vishakha-----asc-libr005--sun-08th--kae3g\"
   ;;     :status :created}"
...
(defn generate-grainpath-url
  "Generate grainpath URL for grainbranch
   ...
   Example:
   (generate-grainpath-url \"grain06pbc\" \"graintime\" \"course/kae3g/grain-fundamentals\")
   ;; => \"https://grain06pbc.github.io/graintime/grainbranch-2025-10-24--1542--PDT--moon-vishakha-----asc-libr005--sun-08th--kae3g/course/kae3g/grain-fundamentals/\""
  [org repo grainpath]
  ;; Implementation details...
  )
```
...
{:graintime {:enabled true
             ...
             :backup-enabled true
             :sync-repos ["grain06pbc/graintime" "kae3g/graintime"]
