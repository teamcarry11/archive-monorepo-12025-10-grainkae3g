...
- `grainstore/grain12pbc-utils/clelte/clelte.bb` (3890 bytes) - Simplified
...
- `grainstore/grain12pbc-utils/clotoko/clotoko.bb` (4289 bytes) - Enhanced
...
- Move utilities to `grain12pbc-utils/`

### **Phase 2: Unify Compiler Files**

**Clelte Compiler**:
- **Primary**: `grainstore/grain12pbc-utils/clelte/clelte.bb`
- **Archive**: Move `clotoko-icp/clelte.bb` to `grain12pbc-utils/clelte/archive/`
- **Remove**: Root level `clelte/clelte.bb`

**Clotoko Compiler**:
- **Primary**: `grainstore/grain12pbc-utils/clotoko/clotoko.bb`
- **Archive**: Move `clotoko-icp/clotoko.bb` to `grain12pbc-utils/clotoko/archive/`
- **Remove**: Root level `clotoko/clotoko.bb`

### **Phase 3: Utility Migration**

**From `clotoko-icp/` to `grain12pbc-utils/`:**
- `poshmark-scraper.bb` → `grain12pbc-utils/poshmark-scraper/`
- `oracle-daemon-plan.md` → `grain12pbc-utils/graindaemon/`
- ICP-specific scripts → `grain12pbc-utils/icp-tools/`
...
mkdir -p grainstore/grain12pbc-utils/clelte/archive
mkdir -p grainstore/grain12pbc-utils/clotoko/archive

# Move old versions
mv grainstore/clotoko/* grainstore/clojure-icp/archive/clotoko-basic/
mv grainstore/clotoko-icp/clelte.bb grainstore/grain12pbc-utils/clelte/archive/
mv grainstore/clotoko-icp/clotoko.bb grainstore/grain12pbc-utils/clotoko/archive/
```
...
mv grainstore/icp-workspace/poshmark-scraper.bb grainstore/grain12pbc-utils/poshmark-scraper/

# Move oracle plan
mv grainstore/icp-workspace/oracle-daemon-plan.md grainstore/grain12pbc-utils/graindaemon/

# Create ICP tools directory
mkdir -p grainstore/grain12pbc-utils/icp-tools
mv grainstore/icp-workspace/setup-testnet.sh grainstore/grain12pbc-utils/icp-tools/
```
