...
(define (get-next-actions)
  ...
  (list
    ...
    (hash
      ...
      "command" "cd /home/xy/kae3g/grainkae3g && steel grainstore/grain12pbc/teamplay04/grainbarrel/scripts/check-grain-width.scm"
    ...
    (hash
      ...
      "action" "Create template (grain12pbc) and personal (kae3g) versions"
    ...
    (hash
      ...
      "command" "Create grains in grainstore/grain12pbc/teamabsorb14/rich-hickey-mode/"
...
(define (main)
  ...
  (let ([actions (get-next-actions)]
    ...
    (displayln "│    Template (grain12pbc) + Personal (kae3g)                                  │")
    (displayln "│                                                                              │")
    (displayln "╰──────────────────────────────────────────────────────────────────────────────╯")
    (displayln "")
