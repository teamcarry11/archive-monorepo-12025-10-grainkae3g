...
- `grain12pbc/graincourse` - Course content management
- `grain12pbc/grainpages` - Static site generation
- `grain12pbc/grainsource-separation` - Configuration pattern
