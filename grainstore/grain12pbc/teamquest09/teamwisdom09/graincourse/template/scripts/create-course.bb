...
(defn create-course-edn [author course-name course-dir]
 ...
 {:grainpath \"" grainpath "\"
  ...
  :repositories
  {:github \"https://github.com/grain12pbc/" repo-name "\"
   :codeberg \"https://codeberg.org/grain12pbc/" repo-name "\"}
  
  :pages
  {:github \"https://grain12pbc.github.io/" repo-name "\"
   :codeberg \"https://grain12pbc.codeberg.page/" repo-name "\"}
  ...
  {:home-text \"🏠 Course Home\"
   :github-url \"https://github.com/grain12pbc/" repo-name "\"
   :codeberg-url \"https://codeberg.org/grain12pbc/" repo-name "\"
   :github-pages \"https://grain12pbc.github.io/" repo-name "/\"
   :codeberg-pages \"https://grain12pbc.codeberg.page/" repo-name "/\"}
  ...
  :deployment
  {:github {:org \"grain12pbc\" :repo \"" repo-name "\" :branch \"gh-pages\"}
   :codeberg {:org \"grain12pbc\" :repo \"" repo-name "\" :branch \"pages\"}}}}")]
...
(defn create-grainpath-edn [author course-name course-dir]
 ...
 {:path \"" grainpath "\"
  ...
  :repositories
  {:github \"grain12pbc/" repo-name "\"
   :codeberg \"grain12pbc/" repo-name "\"}
...
(defn create-github-repo [repo-name]
  ...
  (try
    (shell (str "gh repo create grain12pbc/" repo-name " --public --description \"Immutable course: " repo-name "\""))
...
(defn create-codeberg-repo [repo-name]
  ...
  (try
    (shell (str "gh repo create codeberg.org/grain12pbc/" repo-name " --public --description \"Immutable course: " repo-name "\""))
