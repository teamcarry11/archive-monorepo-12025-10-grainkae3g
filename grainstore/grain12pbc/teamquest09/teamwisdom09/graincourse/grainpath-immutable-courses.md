...
**GitHub**: `https://github.com/grain12pbc/course-{author}-{course-name}-{version}`
**Codeberg**: `https://codeberg.org/grain12pbc/course-{author}-{course-name}-{version}`

**Examples:**
- `grain12pbc/course-kae3g-grain-network-course-v1.0.0`
- `grain12pbc/course-student-algebra-basics-v2.1.0`
- `grain12pbc/course-teacher-advanced-calculus-v1.5.0`
...
# - GitHub repo: grain12pbc/course-kae3g-grain-network-course-1.0.0
# - Codeberg repo: grain12pbc/course-kae3g-grain-network-course-1.0.0
```
...
{:course
 {:grainpath "/course/kae3g/grain-network-course/v1.0.0/"
  ...
  :repositories
  {:github "https://github.com/grain12pbc/course-kae3g-grain-network-course-1.0.0"
   :codeberg "https://codeberg.org/grain12pbc/course-kae3g-grain-network-course-1.0.0"}
  
  :pages
  {:github "https://grain12pbc.github.io/course-kae3g-grain-network-course-1.0.0"
   :codeberg "https://grain12pbc.codeberg.page/course-kae3g-grain-network-course-1.0.0"}
...
{:grainpath
 {:path "/course/kae3g/grain-network-course/v1.0.0/"
  ...
  :repositories
  {:github "grain12pbc/course-kae3g-grain-network-course-1.0.0"
   :codeberg "grain12pbc/course-kae3g-grain-network-course-1.0.0"}
...
1. **GitHub Pages**: `https://grain12pbc.github.io/course-{author}-{name}-{version}/`
2. **Codeberg Pages**: `https://grain12pbc.codeberg.page/course-{author}-{name}-{version}/`
