...
The grain12pbc template system now supports script-based configuration updates, allowing personal customization while maintaining template consistency.
...
- **Module-Specific Configs**: Individual configuration for each grain12pbc module
...
Stored in `grain12pbc/grainconfig/config.edn`:
...
```bash
# Create: grain12pbc/grainconfig/scripts/grainconfig-{module}.bb
```
...
- GitHub Issues: [grain12pbc/grainconfig/issues](https://github.com/grain12pbc/grainconfig/issues)
- Codeberg Issues: [grain12pbc/grainconfig/issues](https://codeberg.org/grain12pbc/grainconfig/issues)
