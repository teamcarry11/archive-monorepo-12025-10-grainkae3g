...
λ cd grainstore/grain12pbc/teamelegance06
λ
```
...
```bash
# Clone template repo
git clone https://github.com/grain12pbc/grainzsh.git ~/.grainzsh
...
alias g6='cd ~/kae3g/grainkae3g/grainstore/grain12pbc'
alias g10='cd ~/kae3g/grainkae3g/grainstore/grain12pbc/teamrebel10'
alias g06='cd ~/kae3g/grainkae3g/grainstore/grain12pbc/teamelegance06'
alias g14='cd ~/kae3g/grainkae3g/grainstore/grain12pbc/teamabsorb14'
...
# Add Steel (Rust Lisp) to PATH
export PATH="$HOME/.cargo/bin:$PATH"
export STEEL_HOME="$HOME/.steel"
[[ -d "$STEEL_HOME/bin" ]] && export PATH="$STEEL_HOME/bin:$PATH"

# Steel aliases
alias steel='steel'
alias st='steel'  # Quick steel REPL
alias steel-repl='steel'
alias steel-run='steel'

# Grain Steel scripts
alias gt-steel='steel grainstore/grain12pbc/teambright01/grainbarrel/scripts/graintime.scm'
alias gp-steel='steel grainstore/grain12pbc/teambright01/grainbarrel/scripts/grain-phi-vortex.scm'
...
```bash
# Fork to grain12pbc
git clone https://github.com/grain12pbc/grainzsh.git
...
- **grainSOURCE**: https://github.com/grain12pbc/grainzsh
- **grainSITE**: https://grain12pbc.github.io/grainzsh/
- **team06**: https://github.com/grain12pbc/teamelegance06
