...
(defn generate-grainbranch-structure
  ...
  TEMPLATE SIDE (grain12pbc/teamNAME##/MODULE/):
  ...
  (let [team-info (get teams team-key)
        ...
        template-path (str "grainstore/grain12pbc/team" team-num "/" module-name "/")
...
(defn generate-grainbranch-section
  ...
  (str "## 🌾 Grainbranch: " grainbranch-name "\n"
       ...
       "\n"
       "**Template ↔ Personal:**\n"
       "- **Template (specs):** `grain12pbc/team*/MODULE/` - shared, reusable foundation\n"
