...
```bash
# Fork to grain12pbc
git clone https://github.com/grain12pbc/grainenvvars.git
...
git submodule add https://github.com/grain12pbc/grainenvvars.git lib/grainenvvars

# Option 2: Copy to your project
cp -r grainenvvars/* myproject/lib/grainenvvars/

# Option 3: Add to deps.edn
{:deps {grainenvvars {:git/url "https://github.com/grain12pbc/grainenvvars"
                      :sha "..."}}}
```
...
- **grainSOURCE**: https://github.com/grain12pbc/grainenvvars
- **grainSITE**: https://grain12pbc.github.io/grainenvvars/
