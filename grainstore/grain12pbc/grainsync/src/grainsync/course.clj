...
(def graintime-module (str grainstore-root "/grain12pbc/graintime"))
(def graincourse-module (str grainstore-root "/grain12pbc/graincourse"))
(def graincourse-sync-module (str grainstore-root "/grain12pbc/graincourse-sync"))
