...
(defn create-grainbranch
  "Create immutable grainbranch with graintime stamp
   ...
   ;;     :url \"https://github.com/grain12pbc/graintime/tree/grainbranch-2025-10-24--1542--PDT--moon-vishakha-----asc-libr005--sun-08th--kae3g\"
   ;;     :status :created}"
...
(defn generate-grainpath-url
  "Generate grainpath URL for grainbranch
   ...
   Example:
   (generate-grainpath-url \"grain12pbc\" \"graintime\" \"course/kae3g/grain-fundamentals\")
   ;; => \"https://grain12pbc.github.io/graintime/grainbranch-2025-10-24--1542--PDT--moon-vishakha-----asc-libr005--sun-08th--kae3g/course/kae3g/grain-fundamentals/\""
  [org repo grainpath]
  ;; Implementation details...
  )
```
...
{:graintime {:enabled true
             ...
             :backup-enabled true
             :sync-repos ["grain12pbc/graintime" "kae3g/graintime"]
