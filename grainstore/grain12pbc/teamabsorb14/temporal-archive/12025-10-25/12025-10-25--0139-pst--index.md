# 🏔️ teamrebel10 - The Wheel of Fortune
...
### Foundation Layer (Template - grain12pbc org)
...
### Ethics Layer (Template - grain12pbc org)
- `grainsource-vegan` - Ethical validation specs (Ketu foundation)

### AI Layer (Template - grain12pbc org)
- `grainai-voice` - Voice personality structure specs

### Systems Layer (Template - grain12pbc org)
- `grain-musl` - Minimal C library foundation template

### Personal Layer (teamrebel10 org - THIS SITE)
- `grainteamrebel10mode` - Personal glo0w implementation
- `grainteamrebel10` - This site (personal team site)
...
**Templates (grain12pbc/teamrebel10/*):**
- Public, shared specs
- Base definitions
- Reusable patterns
- Deployed to grain12pbc org

**Personal (teamrebel10/*):**
- Custom implementations
- Site content (like this!)
- Personal configs
- Deployed to teamrebel10 org

Just like `12025-10` is kae3g's personal site,  
`grainteamrebel10` is team10's personal site!
