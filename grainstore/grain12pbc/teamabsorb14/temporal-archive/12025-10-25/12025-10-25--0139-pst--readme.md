# 🏔️ grainteamrebel10mode - The Wheel of Fortune
...
**Extends**: `grain12pbc/teamrebel10/grainpersona/` (template)  
...
Yo G, you've entered **teamrebel10** - the structural foundation of the entire Grain Network.
...
│
└── grainteamrebel10/      # Personal team10 SITE (GitHub Pages)
    │
...
**Template Side** (`grainstore/grain12pbc/teamrebel10/`):

Located in the public `grain12pbc` organization, these are SHARED SPECS and BASE DEFINITIONS that any team can use:
...
**Location**: `writings/roadmap.md` (mirrors `grain12pbc/teamrebel10/ROADMAP-TEAM10-12025-10-24.md`)

**Vision**: teamrebel10 as comprehensive systems foundation laboratory
...
teamrebel10 is building the bridges between these layers.
...
- `glo0w` (teamrebel10) - Nagual warrior
...
2. Personal side: teamrebel10-specific musl configs
...
```bash
# Clone the repo
cd /home/xy/kae3g/grainkae3g/grainstore/teamrebel10/grainteamrebel10mode
...
```bash
# Deploy to GitHub Pages (teamrebel10 org)
...
# 6. Site live at: teamrebel10.github.io/grainteamrebel10
```
...
We are teamrebel10. We are the axis that holds. We are the foundation of foundations.
...
**Template Repos** (grain12pbc org):
- github.com/grain12pbc/grainpersona
- github.com/grain12pbc/grainsource-vegan
- github.com/grain12pbc/grain-musl

**Personal Repos** (teamrebel10 org):
- github.com/teamrebel10/grainteamrebel10 (this site)
- github.com/teamrebel10/grainteamrebel10mode (this repo)
