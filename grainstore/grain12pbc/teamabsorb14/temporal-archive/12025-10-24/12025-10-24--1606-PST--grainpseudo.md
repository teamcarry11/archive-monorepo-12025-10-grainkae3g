...
**Core Template** (`grain12pbc/grain6`):
...
- `grain12pbc/grain6-education`: Educational institutions
- `grain12pbc/grain6-enterprise`: Corporate environments
- `grain12pbc/grain6-research`: Academic research
- `grain12pbc/grain6-community`: Community organizations

**Personal Templates**:
- `grain12pbc/grain6-personal`: Individual developers
- `grain12pbc/grain6-student`: Students and learners
- `grain12pbc/grain6-contributor`: Open source contributors
- `grain12pbc/grain6-maintainer`: Project maintainers
