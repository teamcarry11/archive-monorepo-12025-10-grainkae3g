...
- ← teamtreasure02 (Taurus/High Priestess) - Source data to convert
- ← teamrebel10 (Capricorn/Wheel) - Specs define valid transforms
- ← teamtravel12 (Pisces/Hanged Man) - Temporal data conversion
