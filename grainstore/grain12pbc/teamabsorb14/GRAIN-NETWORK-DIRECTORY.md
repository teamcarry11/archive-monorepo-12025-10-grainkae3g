...
### **grain12pbc** (Template/Spec Organization)
- **URL**: https://github.com/grain12pbc
- **Purpose**: Public templates, specifications, base definitions
- **Type**: Public, shared, reusable
- **Location**: `grainstore/grain12pbc/` (local mirror)
...
**Location**: `grainstore/grain12pbc/teambright01/`
...
**Location**: `grainstore/grain12pbc/teamtreasure02/`
...
**Location**: `grainstore/grain12pbc/teamdance03/`
...
**Location**: `grainstore/grain12pbc/teamplay04/`
...
**Location**: `grainstore/grain12pbc/teamshine05/`
...
**Location**: `grainstore/grain12pbc/teamelegance06/`
...
**Location**: `grainstore/grain12pbc/teaminspire07/`
...
**Location**: `grainstore/grain12pbc/teamtransform08/`
...
**Location**: `grainstore/grain12pbc/teamquest09/`
...
**Location**: `grainstore/grain12pbc/teamrebel10/`

#### **graintime** ⭐ MAJOR UPDATE (2025-10-26)
- **GitHub**: https://github.com/grain12pbc/teamshine05/graintime
...
**Location**: `grainstore/grain12pbc/teamhelp11/`
...
**Location**: `grainstore/grain12pbc/teamillumine13/`
...
**Location**: `grainstore/grain12pbc/teamabsorb14/`
...
### **Build Tools**
- **Babashka**: `bb` command (delegated to `grainstore/grain12pbc/teamplay04/grainbarrel/`)
...
**Template Side** (grain12pbc org):
- Location: `grainstore/grain12pbc/team[NAME]##/grain[concept]/`
- Contains: Specs, base definitions, schema, template docs
- Purpose: Shared, reusable, general-purpose
- Example: `grain12pbc/teamshine05/graintime/` (graintime specs)
...
**Flow**:
1. Create template in grain12pbc (specs + base)
...
**Organizations**:
- Templates: https://github.com/grain12pbc
