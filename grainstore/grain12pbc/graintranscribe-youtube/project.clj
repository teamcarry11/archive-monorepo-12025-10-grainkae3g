(defproject org.grain12pbc/graintranscribe-youtube "0.1.0-SNAPSHOT"
  :description "YouTube video transcription using Gemini 2.5 Pro - Template module with personal separation"
  :url "https://github.com/grain12pbc/graintranscribe-youtube"
  ...
  ;; Grainpbc metadata
  :grain12pbc {:module-type :template
